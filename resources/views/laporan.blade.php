  ...
  <header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto me-xl-0">
        ...
        <h1 class="sitename">Ombudsman</h1>
      </a>
  ...
  <main class="main">
      ...
      <div class="container text-center" data-aos="fade-up" data-aos-delay="100">
        <div class="row justify-content-center">
          <div class="col-lg-8">
            ...
            <p>Sistem Informasi Pengaduan Ombudsman RI Perwakilan Kalsel</p>
            <a href="#about" class="btn-get-started">Buat Pengaduan </a>
          </div>
        </div>
      </div>
    ...
    <section id="what-we-do" class="what-we-do section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>What We Do</h2>
        <p>Kami siap membantu Anda dalam memeriksa keluhan terkait layanan publik. Melalui dialog, kami bersama-sama mencari solusi terbaik untuk masalah Anda. Kami bekerja secara independen dan tidak memihak, untuk memastikan bahwa setiap suara didengar dan ditindaklanjuti dengan adil.</p>
